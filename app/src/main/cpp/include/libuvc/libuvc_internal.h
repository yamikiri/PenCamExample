...
/** http://falsinsoft.blogspot.tw/2015/02/asynchronous-bulk-transfer-using-libusb.html
 * Alcovision's suck uvc cam has only one bulk transfer and its framesize + 12 bytes,
 * so only 1 transfer for 1 bulk is enought!
 */
#define LIBUVC_NUM_TRANSFER_BUFS 100	/*100*/

//#define LIBUVC_XFER_BUF_SIZE	( 16 * 1024 * 1024 )
#define LIBUVC_XFER_BUF_SIZE	( 2 * 1024 * 1024 )
